#!/usr/bin/env python3
"""Install Claude Code global assets on Windows from this portable template."""
...
def install_global_claude(
    ...
    Raises:
        RuntimeError: If the current platform is not Windows or required Claude
    ...
    items = [
        ...
        (root / "configs" / "statusline" / "statusline.py", claude_root / "statusline.py"),
    ]
    items.extend(
